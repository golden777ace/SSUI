...
### Фаза 14 — Расширение каталога виджетов 🔄 (текущая)
Добавлено: Switch, Radio, Toggle Button, Separator, SpinBox, TextArea, ListBox,
Scroll Bar, GroupBox, Link, Accordion, Scroll Area, Stack Widget, Splitter,
Spinner, Gauge, Tooltip, Toast.
Дальше — остальные пункты каталога (см. ниже).

### Фаза 15 — Полный CSS-каскад ⏳
Наследование, специфичность, комбинаторы, hot-reload стилей.

### Фаза 16 — Виртуализация ⏳
Ленивая отрисовка длинных списков и таблиц.

### Фаза 17 — 3D-интерфейсы и физика взаимодействий ⏳ *(исследовательская)*
