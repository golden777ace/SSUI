...
### Фаза 17 — Tkinter-подобный фасад ⏳ (следующая)
Объявление виджета с параметрами и отдельное размещение.

### Фаза 18 — 3D-интерфейсы и физика взаимодействий ⏳ *(исследовательская)*
