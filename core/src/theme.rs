...
impl Theme {
    ...
    pub fn white() -> Self {
        Self {
            ...
            track: Color::hex(0xEAEAEA),
            selection: Color::hex(0xCCE0FF),
    ...
    pub fn light() -> Self {
        Self {
            ...
            track: Color::hex(0xD8DEE6),
            selection: Color::hex(0xCFE0FF),
    ...
    pub fn dark() -> Self {
        Self {
            ...
            track: Color::hex(0x2A2F38),
            selection: Color::hex(0x274671),
